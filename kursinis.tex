	...
	\item Mokėti už stovėjimo laiką per aplikaciją (vienu paspaudimu).
		\begin{itemize}[label={-}]
			...
			\item Veiklos kontekstas: automobilyje, prietaisas su interneto prieiga
				...
				\end{itemize}
			\item Parinktos nestandartinės metaforos, kurios naujam ar vidutinius įgūdžius turinčiam naudotojui yra nesuprantamos. Ši problema gali būti sprendžiama taikant standartines metaforas ir paprastinant navigaciją sistemoje.
	...
	\item Mokėti už stovėjimo laiką per išmanųjį parkometrą.
		\begin{itemize}[label={-}]
			...
			\item Veiklos kontekstas: automobilyje, prietaisas su interneto prieiga, vairuotojo banko sąskaitoje nepakanka lėšų.
				\begin{itemize}[label={$\bullet$}]
					...
					\item Veiklos trukmė: veikla vykdoma apie 5 min, kai išmokstama mažiau nei 1 min.
				\end{itemize}
			\item Prisirišant prie vieno atsiskaitymo būdo, kyla nesklandumų naudotojams, negalintiems naudotis šiuo atsiskaitymo būdu, nežinantiems, jog nebus alternatyvios galimybės apmokėti už suteiktas paslaugas
		...
		\begin{itemize}[label={-}]
			...
			\item Veiklos kontekstas: automobilyje, prietaisas su interneto prieiga, vairuotojas nežino, kur stovi parkometras
				...
				\end{itemize}
			\item Prisirišant prie parkometrų atsiskaitymo būdo, naudotojams gali būti sudėtinga, sunku surasti, parkometrą, jo paieškoms (kelionei iki jo) švaistomas laikas, už kurį, taip pat, reikia papildomai mokėti.
	...
	\item Mokėjimas už laiką minučių tikslumu.
		\begin{itemize}[label={-}]
			...
			\item Veiklos kontekstas: automobilyje, prietaisas su interneto prieiga, vairuotoja nežino, kiek laiko tiksliai palikti savo automobilį.
				...
				\end{itemize}
			\item Naudotojai tiksliai negali apskaičiuoti, kiek laiko jiems reikėtų palikti automobilį 10 min tikslumu, todėl jie yra priversti permokėti už stovėjimo paslaugas.
...
\begin{enumerate}
	...
	\item
		\begin{samepage}		
			Taip pat konkurentų uniPark mobilioji programėlė, kuri naudojama apmokėti paslaugas už automobilio stovėjimą, tam tikroje uniPark aikštelėje. Jų programėlė turi galimybę parodyti žemėlapyje visas aikšteles, esančias mieste.
			\begin{figure}[H]
				\centering
